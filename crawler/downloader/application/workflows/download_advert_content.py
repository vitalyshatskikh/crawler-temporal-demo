...
@workflow.defn(name=surfer_consts.WorkflowName.DOWNLOAD_ADVERT_CONTENT)
class DownloadAdvertContent:
    @workflow.run
    async def run(self, in_: DownloadIn) -> None:
        workflow.logger.info(
            "starting %s", surfer_consts.WorkflowName.DOWNLOAD_ADVERT_CONTENT,
