...
import (
	...
	"github.com/vitalyshatskikh/crawler-temporal-demo/external-site/docs"
	"github.com/vitalyshatskikh/crawler-temporal-demo/external-site/internal/application/adverts"
	"github.com/vitalyshatskikh/crawler-temporal-demo/external-site/internal/domain"
	"github.com/vitalyshatskikh/crawler-temporal-demo/external-site/internal/infrastructure/repositories"
)
...
func run(cfg *config.Config, logger *zap.Logger) error {
	...
	advertsService := domain.NewAdvertsCRUDService(advertsRepo)
